...
function notebook(){
    return(
        <div id='notebooks' className='notebook'>
            <div className="band">
                <h2>Notebooks</h2>
            </div>
            <div className='notebook-container'>
                <div className='NT'>
                    <img src='https://res.cloudinary.com/dbulfrlrz/images/f_auto,q_auto/v1756814050/wp-pme/llm_blog_cover2x-2/llm_blog_cover2x-2.png?_i=AA' alt='something'></img>
                    <div className='NT-info'>
                        <a href='' style={{color:'#c5050c'}}><h2>Transformers and Their Working, Simplified</h2></a>
                        <p>Kaggle</p>
                    </div>
                ...
                <div className='NT'>
                    <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQ7iirtVw3xiv7nSfwnh15EVAMrBuA5-PT9O_GlHAx62iUODlaCh1gY98&s=10' alt='something'></img>
                    <div className='NT-info'>
